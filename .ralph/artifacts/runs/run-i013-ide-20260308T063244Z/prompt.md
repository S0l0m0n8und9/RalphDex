# Ralph Prompt: replenish-backlog (ideHandoff)
...
5. Surface any ambiguity or blocker that prevented a safe next task from being generated.
6. End with the concrete next task a human or later Ralph iteration should pick up.
