...
async function reconcileCompletionReport(input) {
    ...
    if (requestedStatus === 'done') {
        ...
        const docMode = (0, taskFile_1.isDocumentationMode)(state.selectedTask);
        ...
        if (state.prepared.validationCommand && !report.validationRan) {
            warnings.push(`Completed task without reporting validationRan; configured validation command was '${state.prepared.validationCommand}'.`);
        }
    }
