...
exports.SHARED_WEBVIEW_CSS = void 0;
/**
...
input,select,textarea{background:var(--vscode-input-background);color:var(--vscode-input-foreground);border:1px solid var(--vscode-input-border,transparent);border-radius:2px;padding:3px 6px;font-size:var(--vscode-font-size);font-family:var(--vscode-font-family)}
