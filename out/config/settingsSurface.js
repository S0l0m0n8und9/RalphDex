...
const SETTINGS_SURFACE_REGISTRY = [
    ...
    { key: 'reasoningEffort', manifestKey: 'ralphCodex.reasoningEffort', sectionId: 'model-reasoning', title: 'Reasoning Effort', control: 'enum', description: 'Global reasoning effort default for provider runs.', options: ['medium', 'high'] },
