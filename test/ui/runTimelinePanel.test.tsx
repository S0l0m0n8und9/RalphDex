...
function section(overrides: Partial<DashboardRunTimelineSection> = {}): DashboardRunTimelineSection {
  return {
    ...
    totals: { taskStateChanges: 2, providerInvocations: 1, remediationsApplied: 1, recoveryActionsApplied: 1, workflowPhasesCompleted: 0, artifactsWritten: 3, scmActions: 1 },
    entries: [
