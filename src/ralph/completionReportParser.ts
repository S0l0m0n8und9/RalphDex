...
function parseValidationRan(value: unknown): string | undefined {
...
export function parseCompletionReport(lastMessage: string): ParsedCompletionReport {
  ...
  const report: RalphCompletionReport = {
    ...
    suggestedChildTasks,
    doctrineUpdates: doctrineUpdates.updates.length > 0 ? doctrineUpdates.updates as DoctrineProposedUpdate[] : undefined,
