...
const SETTINGS_SURFACE_REGISTRY: Array<{
  ...
  { key: 'modelTiering.simple.provider', manifestKey: 'ralphCodex.modelTiering', sectionId: 'provider', title: 'Simple Tier: Provider', control: 'enum', description: 'Optional provider override for the Simple tier.', options: ['claude', 'codex', 'copilot', 'copilot-byok', 'copilot-foundry', 'azure-foundry', 'gemini'] },
  { key: 'modelTiering.simple.reasoningEffort', manifestKey: 'ralphCodex.modelTiering', sectionId: 'provider', title: 'Simple Tier: Reasoning Effort', control: 'enum', description: 'Optional reasoning-effort override for the Simple tier. Falls back to global reasoningEffort when omitted.', options: ['medium', 'high'] },
  ...
  { key: 'modelTiering.medium.provider', manifestKey: 'ralphCodex.modelTiering', sectionId: 'provider', title: 'Medium Tier: Provider', control: 'enum', description: 'Optional provider override for the Medium tier.', options: ['claude', 'codex', 'copilot', 'copilot-byok', 'copilot-foundry', 'azure-foundry', 'gemini'] },
  { key: 'modelTiering.medium.reasoningEffort', manifestKey: 'ralphCodex.modelTiering', sectionId: 'provider', title: 'Medium Tier: Reasoning Effort', control: 'enum', description: 'Optional reasoning-effort override for the Medium tier. Falls back to global reasoningEffort when omitted.', options: ['medium', 'high'] },
  ...
  { key: 'modelTiering.complex.provider', manifestKey: 'ralphCodex.modelTiering', sectionId: 'provider', title: 'Complex Tier: Provider', control: 'enum', description: 'Optional provider override for the Complex tier.', options: ['claude', 'codex', 'copilot', 'copilot-byok', 'copilot-foundry', 'azure-foundry', 'gemini'] },
  { key: 'modelTiering.complex.reasoningEffort', manifestKey: 'ralphCodex.modelTiering', sectionId: 'provider', title: 'Complex Tier: Reasoning Effort', control: 'enum', description: 'Optional reasoning-effort override for the Complex tier. Falls back to global reasoningEffort when omitted.', options: ['medium', 'high'] },
