...
function readConfig(workspaceFolder) {
    ...
    return {
        ...
        claudePermissionMode: readEnum(config, 'claudePermissionMode', ['dangerously-skip-permissions', 'bypassPermissions', 'default'], defaults_1.DEFAULT_CONFIG.claudePermissionMode),
