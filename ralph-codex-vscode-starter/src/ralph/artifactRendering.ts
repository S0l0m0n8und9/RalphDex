...
import type { RalphIterationArtifactPaths } from './artifactStore';
...
export function formatTrustLevel(value: RalphProvenanceTrustLevel): string {
...
export function renderPreflightSummary(report: RalphPersistedPreflightReport): string {
...
export function renderIterationSummary(input: {
...
export function renderIntegrityFailureSummary(failure: RalphIntegrityFailure): string {
  return [
...
export function renderProvenanceSummary(bundle: RalphProvenanceBundle): string {
...
export function renderLatestResultSummary(record: Record<string, unknown>): string | null {
  ...
  const remediationSummary = typeof (record.remediation as Record<string, unknown> | null)?.summary === 'string'
    ? (record.remediation as Record<string, unknown>).summary as string
    : 'none';
  ...
  const backlog = typeof record.backlog === 'object' && record.backlog !== null
    ? record.backlog as Record<string, unknown>
    : null;
...
export function latestResultFromIteration(input: {
  result: RalphIterationResult;
  paths: RalphIterationArtifactPaths;
  diffSummary: RalphDiffSummary | null;
...
export function looksLikePreflightRecord(record: Record<string, unknown> | null): boolean {
...
export function looksLikeIntegrityFailure(record: Record<string, unknown> | null): boolean {
...
export function looksLikeProvenanceBundle(record: Record<string, unknown> | null): boolean {
...
export function provenanceIdFromRecord(record: Record<string, unknown> | null): string | null {
